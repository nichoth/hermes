...
import { FunctionComponent, Component, createContext,
  ComponentChildren, ComponentChild } from 'preact';
...
const WebnativeProvider: FunctionComponent<Props> = ({
  ...
  if (!state) {
    return loading || html`<div>Loading...</div>`
  }
